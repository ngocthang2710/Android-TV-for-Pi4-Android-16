/*
 * "CH Play" for this device: a WebView wrapper around
 * https://play.google.com/store (no GMS/Play Services on this AOSP build,
 * and no Play Store backend to actually install anything even if there
 * were -- see the AndroidManifest.xml comment). Browse-only: reuses
 * everything learned building YouTubeTv/SpotifyTv (predictive-back
 * opt-out, force-navigate-to-home BACK, Escape-key fallback, double-back-
 * to-exit) rather than rediscovering those bugs again here.
 */
package com.rpi4tv.playstoretv;
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHomeUrl = getString(R.string.play_store_url);
     ...
     * {@link #isHomeUrl} is path-based like SpotifyTv's (play.google.com
     * uses normal path routing -- "/store/apps/details", "/store/search",
     * etc. -- not hash fragments).
     */
    @Override
